...
public class Window extends JComponent implements WindowListener {
    ...
    private ImageIcon gameButtonIcon1,SnakeGameIcon,paddelGameIcon,ticTakGameIcon,dinoRunnerGameIcon,waveGameIcon;
